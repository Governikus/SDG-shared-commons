...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$ln ='RegistryResponse'">
          <xsl:attribute name="id">R-LCM-SUC-001</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>The root element of a query response document MUST be 'rs:RegistryResponse'</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M6" select="@*|*" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$ns ='urn:oasis:names:tc:ebxml-regrep:xsd:rs:4.0'">
          <xsl:attribute name="id">R-LCM-SUC-002</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="rs:RegistryResponse/@requestID" mode="M8" priority="1000">
    <svrl:fired-rule context="rs:RegistryResponse/@requestID" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="matches(normalize-space((.)),'^[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}$','i')">
          <xsl:attribute name="id">R-LCM-SUC-004</xsl:attribute>
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="rs:RegistryResponse" mode="M9" priority="1000">
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@requestID">
          <xsl:attribute name="id">R-LCM-SUC-003</xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@status">
          <xsl:attribute name="id">R-LCM-SUC-005</xsl:attribute>
          <xsl:attribute name="flag">FATAL</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$status = 'urn:oasis:names:tc:ebxml-regrep:ResponseStatusType:Success'">
          <xsl:attribute name="id">R-LCM-SUC-006</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>The 'status' attribute of a successful 'rs:RegistryResponse' MUST be encoded as as 'urn:oasis:names:tc:ebxml-regrep:ResponseStatusType:Success'.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(rim:RegistryObjectList) = 0">
          <xsl:attribute name="id">R-LCM-SUC-007</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>A successful 'rs:RegistryResponse' does not include a 'rim:RegistryObjectList'</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>

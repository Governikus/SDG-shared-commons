...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$ln ='QueryResponse'">
          <xsl:attribute name="id">R-EB-REQ-S001</xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$ns ='urn:oasis:names:tc:ebxml-regrep:xsd:query:4.0'">
          <xsl:attribute name="id">R-EB-REQ-S002</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="@status='urn:oasis:names:tc:ebxml-regrep:ResponseStatusType:Success'">
          <xsl:attribute name="id">R-EB-REQ-S006</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(rim:RegistryObjectList) = 1">
          <xsl:attribute name="id">R-EB-REQ-S007</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>A successful OOTS response includes a RegistryObjectList</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(rs:Exception) = 0">
          <xsl:attribute name="id">R-EB-REQ-S008</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>A successful OOTS response does not include an Exception</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M9" select="@*|*" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(rim:RegistryObjectList) = 0">
          <xsl:attribute name="id">R-EB-REQ-S009</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(rs:Exception) = 1">
          <xsl:attribute name="id">R-EB-REQ-S010</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="rim:RegistryObject" mode="M10" priority="1001">
    <svrl:fired-rule context="rim:RegistryObject" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="rim:Slot[@name='Requirement']" />
      <xsl:otherwise>
        <svrl:failed-assert test="rim:Slot[@name='Requirement']">
          <xsl:attribute name="id">R-EB-REQ-S011</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>The rim:Slot name="Requirement" MUST be present in the QueryResponse.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M10" select="@*|*" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="count(rim:Slot) = 1">
          <xsl:attribute name="id">R-EB-REQ-S012</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>A registry object in an EB response must contain one and only one Slot</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M10" select="@*|*" />
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="rim:Slot[@name='Requirement']/rim:SlotValue" mode="M11" priority="1000">
    <svrl:fired-rule context="rim:Slot[@name='Requirement']/rim:SlotValue" />
...
<xsl:choose>
      ...
      <xsl:otherwise>
        <svrl:failed-assert test="$st ='AnyValueType'">
          <xsl:attribute name="id">R-EB-REQ-S013</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>The rim:SlotValue of rim:Slot name="Requirement" MUST be of "rim:AnyValueType"<xsl:text />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="count(sdg:Requirement)=1" />
      <xsl:otherwise>
        <svrl:failed-assert test="count(sdg:Requirement)=1">
          <xsl:attribute name="id">R-EB-REQ-S014</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>A  rim:Slot[@name=Requirement]/rim:SlotValue MUST contain one sdg:Requirement of the targetNamespace="http://data.europa.eu/p4s</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M11" select="@*|*" />
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="rim:Slot[@name='Requirement']/rim:SlotValue/sdg:Requirement/sdg:ReferenceFramework/sdg:RelatedTo" mode="M12" priority="1000">
    <svrl:fired-rule context="rim:Slot[@name='Requirement']/rim:SlotValue/sdg:Requirement/sdg:ReferenceFramework/sdg:RelatedTo" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="count(sdg:Identifier)=1" />
      <xsl:otherwise>
        <svrl:failed-assert test="count(sdg:Identifier)=1">
          <xsl:attribute name="id">R-EB-REQ-S015</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>The xs:element name="RelatedTo" type="sdg:ReferenceFrameworkType"/ MUST only contain the 'sdg:Identifier'</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M12" select="@*|*" />
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="rim:Slot[@name='Requirement']/rim:SlotValue/sdg:Requirement" mode="M13" priority="1000">
    <svrl:fired-rule context="rim:Slot[@name='Requirement']/rim:SlotValue/sdg:Requirement" />

		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="count(sdg:EvidenceTypeList)=0" />
      <xsl:otherwise>
        <svrl:failed-assert test="count(sdg:EvidenceTypeList)=0">
          <xsl:attribute name="id">R-EB-REQ-S016</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
          <svrl:text>The xs:element name="Requirement" MUST not contain the EvidenceTypeList.</svrl:text>
        </svrl:failed-assert>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:apply-templates mode="M13" select="@*|*" />
